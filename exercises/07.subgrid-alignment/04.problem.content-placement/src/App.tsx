...
export default function App() {
  return (
    <div className="grid min-h-screen place-items-center px-4 py-16">
      <div
        className={clsx(
          "grid place-items-center gap-12 sm:gap-16 xl:grid-cols-[auto_1fr] xl:gap-x-24 xl:gap-y-4",
          "xl:max-w-7xl",
        )}
      >
        <div
          className={clsx(
            ...
            "xl:col-start-2 xl:row-span-2 xl:row-start-3 xl:grid xl:max-w-none xl:grid-rows-subgrid grid-cols-[auto_1fr] xl:gap-x-4",
          )}
        >
          <EpicStackLogo
            className={clsx(
          ...
          <p
            className={clsx(
              "mt-4 text-slate-600 sm:text-lg md:mt-6 md:text-xl xl:col-span-2",
              // Animation
