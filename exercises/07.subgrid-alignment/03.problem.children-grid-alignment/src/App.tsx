  ...
  return (
    <div className="grid min-h-screen place-items-center px-4 py-16">
      <div className="grid place-items-center gap-12 sm:gap-16 xl:grid-cols-[auto_1fr] xl:gap-x-24 xl:gap-y-4">
        <div
          className={clsx(
            "flex max-w-md flex-col items-center text-centers",
            "xl:items-start xl:text-left xl:grid xl:grid-rows-subgrid xl:row-span-2 xl:col-start-2 xl:row-start-3 xl:max-w-none",
          )}
        >
          <EpicStackLogo
            className={clsx(
