        ...
        <ul className="flex max-w-3xl flex-wrap justify-center gap-2 sm:gap-4 xl:grid xl:grid-flow-col xl:grid-cols-5 xl:grid-rows-6">
          {logos.map((logo) => (
            ...
            >
              <a
                href={logo.href}
                className="bg-highlight/[7%] grid size-20 place-items-center rounded-2xl p-4 sm:size-24 hover:-rotate-6 transition hover:bg-highlight/10 focus:ring-highlight focus:outline-none focus:ring-2 focus:ring-offset-2"
              >
