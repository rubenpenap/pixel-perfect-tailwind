    ...
    <div className="grid min-h-screen place-items-center px-4 py-16">
      <div className="grid place-items-center gap-12 sm:gap-16 xl:grid-cols-[auto_1fr] xl:gap-24">
        <div className="flex max-w-md flex-col items-center text-center xl:order-2 xl:items-start xl:text-left">
          <EpicStackLogo className="size-20 animate-slide-top" />
          <h1 className="sm:text-4.5xl lg:text-5.5xl mt-6 text-4xl font-medium md:mt-8 md:text-5xl animate-slide-top [animation-delay:300ms] [animation-fill-mode:backwards]">
            The <span className="text-highlight">Epic</span> Stack
          </h1>
          <p className="mt-4 text-slate-600 sm:text-lg md:mt-6 md:text-xl animate-slide-top [animation-delay:800ms]  [animation-fill-mode:backwards]">
            Check the{" "}
            <a
